...
const createFormId = 'admin-plan-create-form'
const {
  hasUnsavedChanges,
  isSubmitting,
  canSubmit,
...
useSeoMeta({
  title: 'Gestión de planes | Crear nuevo plan | Heltifud Meal Preps',
  description: 'Crea un nuevo plan dentro del panel administrativo de Heltifud Meal Preps.',
...
<template>
  <AdminEditorPageShell
    title="Nuevo plan"
    description="Configura el plan en un orden simple: identidad comercial, disponibilidad y contexto interno."
  >
    <template #actions>
      <UButton
        color="neutral"
